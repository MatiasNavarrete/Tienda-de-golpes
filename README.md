...
Ecosistema distribuido y escalable desarrollado en *Java 24* con *Spring Boot 4.0.x, diseñado bajo un patrón de arquitectura limpia y comunicación asrónica/sincrónica entre servicios. Las bases de datos se gestionan de forma independiente mediante **Flyway Migrations*.
