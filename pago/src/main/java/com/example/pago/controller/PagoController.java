...
public class PagoController {
    ...
    @Operation(
            ...
            description = "Valida los datos de la transacción financiera, efectúa el cobro y actualiza el estado de la orden"
    )
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Pago procesado y aprobado con éxito",
